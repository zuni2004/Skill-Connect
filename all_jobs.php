...
$jobs = [];
$sql = "SELECT * FROM job_postings WHERE post_status = 'Active' ORDER BY posted_at DESC";
...
<head>
  ...
  <title>All Jobs | SkillConnect</title>
...
<body>
  ...
  <section class="jobs-list-section">
    <div class="container">
      <h2 class="fw-bold mb-4 text-center">All Jobs</h2>
      <div class="row g-4">
        <?php if (empty($jobs)): ?>
          <div class="col-12">
            ...
            <div class="col-md-4">
              <div class="card job-card h-100">
                <div class="card-body">
                  ...
                  <button class="btn btn-outline-primary btn-sm" onclick="window.location.href='login.html'">Apply
                    Now</button>
                </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-4 mb-4">
          ...
          <ul class="list-unstyled">
            ...
            <li class="mb-2">
              <a href="./all_courses.html" class="text-white text-decoration-none">All Courses</a>
            </li>
            <li class="mb-2">
